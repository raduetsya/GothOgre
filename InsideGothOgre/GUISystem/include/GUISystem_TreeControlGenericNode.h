/*!
	...
	@date       08/2009
*/
#ifndef GUISYSTEM_TREE_CONTROL_GENERIC_NODE_H
#define GUISYSTEM_TREE_CONTROL_GENERIC_NODE_H
...
namespace GUISystem
{
	...
	public:
		...
		GenericNode(const MyGUI::UString& strText, NODE* pParent = nullptr);
		virtual ~GenericNode();
...
#endif // GUISYSTEM_TREE_CONTROL_GENERIC_NODE_H
